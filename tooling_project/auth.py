from flask import Blueprint, Flask, render_template, request, redirect, url_for, session, logging, flash
...
def register_post():
    ...
    new_user = User(id = ID, name = name, email = email, password = generate_password_hash(password, method='sha256'))
